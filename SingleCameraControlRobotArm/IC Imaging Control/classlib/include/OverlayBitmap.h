...
namespace _DSHOWLIB_NAMESPACE
{
	...
	public:
		...
		bool		setFont( const dstringa& szFaceName, int iSize = 10 );
		bool		setFont( const dstringw& szFaceName, int iSize = 10 );
		...
		bool		drawText( COLORREF color, int iX, int iY, const dstringa& text );
		bool		drawText( COLORREF color, int iX, int iY, const dstringw& text );
